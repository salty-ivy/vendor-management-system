...
SECRET_KEY = "django-insecure-9o-%qprfet^wnt@(3*1d2f)&nm@6g)!m&b^h&jmmkzh@4)%#kp"
...
DATABASES = {
    "default": {
        "ENGINE": os.environ.get("ENGINE") or "django.db.backends.sqlite3",
